...
export type OrderWhereInput = {
  ...
  oid?: Prisma.IntFilter<"Order"> | number
...
export type OrderScalarWhereWithAggregatesInput = {
  ...
  oid?: Prisma.IntWithAggregatesFilter<"Order"> | number
...
export type OrderOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"oid" | "totalAmount" | "status" | "userId" | "createdAt", ExtArgs["result"]["order"]>
...
export interface OrderDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `oid`
   * const orderWithOidOnly = await prisma.order.findMany({ select: { oid: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Orders and only return the `oid`
   * const orderWithOidOnly = await prisma.order.createManyAndReturn({
   *   select: { oid: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Orders and only return the `oid`
   * const orderWithOidOnly = await prisma.order.updateManyAndReturn({
   *   select: { oid: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface OrderFieldRefs {
  readonly oid: Prisma.FieldRef<"Order", 'Int'>
