...
export type OrderItemWhereInput = {
  ...
  oiid?: Prisma.IntFilter<"OrderItem"> | number
...
export type OrderItemScalarWhereWithAggregatesInput = {
  ...
  oiid?: Prisma.IntWithAggregatesFilter<"OrderItem"> | number
...
export type OrderItemUncheckedUpdateInput = {
  oiid?: Prisma.IntFieldUpdateOperationsInput | number
  quantity?: Prisma.IntFieldUpdateOperationsInput | number
...
export type OrderItemOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"oiid" | "quantity" | "orderId" | "productId", ExtArgs["result"]["orderItem"]>
...
export interface OrderItemDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `oiid`
   * const orderItemWithOiidOnly = await prisma.orderItem.findMany({ select: { oiid: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many OrderItems and only return the `oiid`
   * const orderItemWithOiidOnly = await prisma.orderItem.createManyAndReturn({
   *   select: { oiid: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more OrderItems and only return the `oiid`
   * const orderItemWithOiidOnly = await prisma.orderItem.updateManyAndReturn({
   *   select: { oiid: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface OrderItemFieldRefs {
  readonly oiid: Prisma.FieldRef<"OrderItem", 'Int'>
