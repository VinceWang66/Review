...
export type ProductWhereInput = {
  ...
  pid?: Prisma.IntFilter<"Product"> | number
  pname?: Prisma.StringFilter<"Product"> | string
...
export type ProductScalarWhereWithAggregatesInput = {
  ...
  pid?: Prisma.IntWithAggregatesFilter<"Product"> | number
  pname?: Prisma.StringWithAggregatesFilter<"Product"> | string
...
export type ProductOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"pid" | "pname" | "description" | "stock" | "price" | "categoryId" | "sellerId" | "createdAt" | "updatedAt", ExtArgs["result"]["product"]>
...
export interface ProductDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * })
   * 
   * // Create many Products and only return the `pid`
   * const productWithPidOnly = await prisma.product.createManyAndReturn({
   *   select: { pid: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Products and only return the `pid`
   * const productWithPidOnly = await prisma.product.updateManyAndReturn({
   *   select: { pid: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ProductFieldRefs {
  readonly pid: Prisma.FieldRef<"Product", 'Int'>
  readonly pname: Prisma.FieldRef<"Product", 'String'>
